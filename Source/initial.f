!===============================================================================
!
! All routines related to the allocation and initialisation of arrays and parameters.
!
!===============================================================================
SUBROUTINE SETCONSTANTS
!===============================================================================
USE CONSTANTS_EBM , ONLY : pi, loutmax , StefBoltz , Tkel
USE INPUT_EBM, ONLY: dzrad, zradmax
USE RADPEN_EBM , ONLY : nlradmax

IMPLICIT NONE

pi = 2*asin(1.)
loutmax = StefBoltz*(Tkel**4)
...
&						hsnowmod , dsnowr , dsnowh , dsnowacc ,  hmass , totwater, topwater, topsnow, topmass,&
